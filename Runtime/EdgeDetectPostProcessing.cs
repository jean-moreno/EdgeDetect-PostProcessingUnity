...
namespace UnityEngine.Rendering.PostProcessing
{
    ...
    public class EdgeDetectPostProcessingRenderer<T> : PostProcessEffectRenderer<T> where T : EdgeDetectPostProcessing
    {
        public override void Render(PostProcessRenderContext context)
        {
            ...
            PropertySheet sheet = context.propertySheets.Get(Shader.Find("Hidden/EdgeDetect-PostProcess"));
            ...
            sheet.properties.SetVector("_EdgeColor", settings.edgesColor.value);
